...
object ActionTypes {
    ...
    // const val GET_TEXT_FROM_ELEMENT = "GET_TEXT_FROM_ELEMENT" // Params: ELEMENT_RESOURCE_ID or ELEMENT_TEXT (Advanced: needs return mechanism)
    ...
    // Add more simple actions as envisioned. Complex read actions are deferred for now.
}
...
object ParameterKeys {
    ...
    const val ELEMENT_TEXT_TO_CLICK = "element_text_to_click" // Text on a button or view
    ...
    const val SCROLL_DIRECTION = "scroll_direction" // "UP", "DOWN", "LEFT", "RIGHT"
